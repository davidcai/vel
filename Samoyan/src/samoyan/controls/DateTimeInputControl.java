...
public class DateTimeInputControl extends InputControl
{
	private boolean dateInputSupported;
	
	public DateTimeInputControl(WebPage outputPage, String name)
	{
...
//			(ua.isChrome() && ua.getVersionChrome()>=10F) ||
	...
	public DateTimeInputControl setPlaceholder(String placeholder)
	{
