...
public class RenderImageLogEntry extends LogEntry
{
	public RenderImageLogEntry(long renderDuration, long deliverDuration, int sizeBytes)
	{
		super("Render image", INFO);
